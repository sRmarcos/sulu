...
/**
 * Copyof WebApiContext from behat, but with protected instead of private
 * methods.
 *
...
class WebApiContext implements ApiClientAwareContext
{
    ...
    {
        $jsonString = $this->replacePlaceHolder($jsonString->getRaw());
        $etalon = json_decode($jsonString, true);
        $actual = $this->response->json();

        if (null === $etalon) {
            throw new \RuntimeException(
              "Can not convert etalon to json:\n" . $this->replacePlaceHolder($jsonString)
            );
        }
